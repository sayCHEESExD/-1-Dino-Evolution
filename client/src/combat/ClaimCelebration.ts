...
/**
 * THE WIN CLAIM CELEBRATION: trophies pop in round the rider, spiral in and
...
export class ClaimCelebration {
  ...
  /** Start round the rider at `anchor` (followed as it moves). A second call while playing is ignored. */
