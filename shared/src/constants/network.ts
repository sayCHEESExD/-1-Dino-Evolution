...
export const MessageType = {
  ...
  Move: 'move',
  /** Client -> server: one attack, with an optional target HINT. Never a damage figure. */
  Attack: 'attack',
  /** Server -> client: an attack was accepted: the Damage it paid and any hit it dealt. */
  Hit: 'hit',
  ...
  /** Client -> server: "I am standing on this dinosaur's pad: buy it, or ride it if owned." */
  DinoPad: 'dinoPad',
  /** Client -> server: buy or ride a dinosaur from the Dinos menu. */
  DinoSelect: 'dinoSelect',
  /** Client -> server: equip / unequip / delete an item, or equip the best three. */
  ItemAction: 'itemAction',
  /** Server -> client: a defeated dinosaur dropped an item into the bag. */
