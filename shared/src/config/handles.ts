...
const FIRST = [
  'Swift', 'Bold', 'Wild', 'Lucky', 'Primal', 'Iron', 'Jungle', 'Storm',
  'Sunny', 'Rapid', 'Mega', 'Amber', 'Frost', 'Ember', 'Jade', 'Fossil',
] as const;

const SECOND = [
  'Raptor', 'Titan', 'Rex', 'Claw', 'Fang', 'Stomp', 'Strider', 'Horn',
  'Tracker', 'Trail', 'Roar', 'Spike', 'Hunter', 'Charger', 'Crest', 'Scale',
] as const;
