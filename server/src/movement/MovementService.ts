 ...
 * ridden dinosaur's width and which gates are open come from the player's
...
export class MovementService {
  ...
  /** Stop a player where they stand (the moment of death): horizontal velocity to zero, gravity kept. */
  ...
  applyInput(sessionId: string, player: PlayerState, message: MoveMessage): boolean {
    ...
    sim.params.radius = riddenDino(player.dinoSlot, player.ownedDinos).radius;
