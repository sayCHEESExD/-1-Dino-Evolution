...
/**
 * Server authority over pets: ownership, hatching and equipment (up to four).
 *
 ...
 * it never describes one. Damage per attack is re-derived after every change.
 */
export class PetService {
  hatch(player: PlayerState, eggRaw: unknown, countRaw: unknown, progression: ProgressionService): HatchResult {
    ...
    if (Math.hypot(player.x - placement.x, player.z - HATCHERY.padZ) > HATCHERY.serviceRadius) {
